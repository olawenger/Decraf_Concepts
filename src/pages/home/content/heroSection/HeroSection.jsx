    ...
    <div>
       ...
       <div className=' absolute  left-0 right-0 flex top-16  lg:top-14 z-30 justify-center items-center lg:justify-start transform translate-y-[7%]'>
          ...
          <div className= 'w-full pt-5 lg:w-1/2 '>
           <h1 className='w-full hero-text text-white-100 text-center  lg:text-start pt-3  lg:pt-6 xl:pt-10'><span className='hero-text bg-[#fb923c]  text-center lg:text-start'>WELCOME</span> To Decraf</h1>
