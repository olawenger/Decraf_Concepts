...
const HeroSection = () => {
  return (
    <div className='z-40'>
       ...
       <div className=' absolute  left-0 right-0 flex top-24  lg:top-14 z-30 justify-center items-center lg:justify-start transform translate-y-[7%]'>
          <div className='w-11/12 mx-auto responsive pt-3 md:pt-7 lg:pt-8'>
          <div className= 'w-full  lg:w-1/2 '>
           <h1 className='w-full hero-text text-white-100 text-center text-2xl sm:text-5xl lg:text-start pt-3  md:pt-12  lg:pt-6 xl:pt-12'><span className='hero-text bg-[#fb923c] text-2xl sm:text-4xl  text-center lg:text-start'>WELCOME</span>  To Decraf</h1>
           <p className='py-1 md:py-5 text-white-100 text-center text-sm   md:text-lg lg:text-start font-poppins leading-relaxed'>Where innovation meets excellence in construction and consultancy. As a leading force in Nigeria's construction industry, we deliver top-notch civil, electrical, and mechanical solutions, complemented by cutting-edge interior finishing and professional services. Our new subsidiary extends our commitment to quality, offering expert consultancy and training in food safety and quality systems for small and medium-scale food processing outfits. Join us in shaping a sustainable and superior future, one project at a time.</p>
