  ...
  return (
    <div className='z-40'>
       ...
       <div className=' absolute  left-0 right-0 flex top-16  lg:top-14 z-30 justify-center items-center lg:justify-start transform translate-y-[7%]'>
          <div className='w-11/12 mx-auto responsive pt-7 lg:pt-8'>
          <div className= 'w-full  lg:w-1/2 '>
           <h1 className='w-full hero-text text-white-100 text-center   lg:text-start pt-12  lg:pt-6 xl:pt-12'><span className='hero-text bg-[#fb923c]  text-center lg:text-start'>WELCOME</span>  To <br className="md:hidden"/> Decraf</h1>
